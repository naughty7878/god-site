...
*/
var num=0,oUl=$("#min_title_list"),hide_nav=$("#Hui-tabNav"),regExp=/skin\/.*\/skin.css/;
...
function getskincookie(){
	...
	if(hrefStr!=undefined){
		var hrefRes = hrefStr.replace(hrefStr.match(regExp)[0], 'skin/'+v+'/skin.css');
...
$(function(){
	...
	$("#Hui-skin .dropDown-menu a").click(function(){
		...
		$('#iframe_box').find('iframe').each(function(){
			$(this).contents().find("#skin").attr("href",hrefRes);
		});
	});
});
