...
<body>
		...
		<div class="navbar navbar-fixed-top">
			<div class="container-fluid cl">
				<a class="logo navbar-logo f-l mr-10 hidden-xs"
					href="/aboutHui.shtml">God 后台管理系统</a> <a
					...
					<ul class="cl">
						...
						<li class="dropDown dropDown_hover"><a href="#"
							...
							<ul class="dropDown-menu menu radius box-shadow">
								...
								<!-- <li><a href="#">切换账户</a></li>  -->
								<li><a onclick="doLogout()" href="javascript:;">退出</a></li>
							</ul></li>
						<!-- 
		...
		<div id="iframe_box" class="Hui-article">
			<div class="show_iframe">
				...
				<iframe id="iframe-welcome" data-scrolltop="0" scrolling="yes"
					frameborder="0" src="${pageContext.request.contextPath }/home/welcome"></iframe>
			</div>
		</div>
	</section>
	...
	<script type="text/javascript">
	    ...
	    function doLogout(){
	        ...
	        xhr.open('POST','${pageContext.request.contextPath }/login/doLogout');
