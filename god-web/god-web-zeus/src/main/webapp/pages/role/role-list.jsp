...
<body>
	...
	<div class="page-container" id="user-container">
		<div class="text-c">
			...
			<input type="text" class="input-text" style="width: 250px"
				placeholder="角色名称" id="" name="keyword">
	...
	<script type="text/javascript">
		...
		function initLayPage(pageConf) {
		    ...
		    $.ajax({
				type:'post',
				url:'${pageContext.request.contextPath }/role/pageList',
		...
		function fillTable(data, num) {
		    ...
		    $.each(data, function (index, obj) {
		        ...
		        info += '<a title="编辑" href="javascript:;" onclick="role_update(\'角色编辑\',\'${pageContext.request.contextPath }/role/toUpdate/'+ obj.id +'\',' + obj.id + ',\'800\', \'500\')" class="ml-5" style="text-decoration: none"><i class="Hui-iconfont">&#xe6df;</i></a>';
